...
function fromString(str) {
  return Stdlib__Option.flatMap(Stdlib__Option.map(Stdlib_JSON.Decode.array(JSON.parse(str)), arr => arr.map(num => Stdlib__Option.flatMap(Stdlib_JSON.Decode.float(num), x => x | 0))), Stdlib__Tuple2.fromArray);
}
