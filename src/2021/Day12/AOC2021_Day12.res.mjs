...
import * as Belt_SortArrayString from "@rescript/runtime/lib/es6/Belt_SortArrayString.js";
import * as Primitive_exceptions from "@rescript/runtime/lib/es6/Primitive_exceptions.js";
import * as Belt_MutableSetString from "@rescript/runtime/lib/es6/Belt_MutableSetString.js";
...
let ParseError = /* @__PURE__ */Primitive_exceptions.create("AOC2021_Day12-AdventOfCode.Maze.ParseError");

function make(edges) {
  let maze = AdjacencyList$AdventOfCode.Node.$$String.make();
  Belt_Array.forEach(edges, edge => {
    ...
    let a = edge[0];
    let b = edge[1];
    AdjacencyList$AdventOfCode.Node.$$String.addNode(maze, a);
    AdjacencyList$AdventOfCode.Node.$$String.addNode(maze, b);
    AdjacencyList$AdventOfCode.Node.$$String.addDirectedEdge(maze, a, b, undefined);
    AdjacencyList$AdventOfCode.Node.$$String.addDirectedEdge(maze, b, a, undefined);
  });
  return maze;
}
...
function get_edges(t, node) {
  return AdjacencyList$AdventOfCode.Node.$$String.neighbors(t, node);
}
...
function dfs(visit_func, t, start_node, end_node) {
  let explore = (node, visited, acc, end_node) => {
    let visited$p = Utils$AdventOfCode.hashMapStringUpdate(visited, node, Utils$AdventOfCode.increaseBy1);
    if (node === end_node) {
      return [acc];
    }
...
function parse(data) {
  return Belt_Array.map(Belt_Array.map(Utils$AdventOfCode.splitNewline(data), prim => prim.trim()), __x => __x.split("-"));
}
