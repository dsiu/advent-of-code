...
function getLowPoints(t) {
  return Array2D$AdventOfCode.reduceWithIndex(t, [], (a, p, param) => {
    let y = param[1];
    let x = param[0];
...
function getAllPoints(t) {
  return Array2D$AdventOfCode.reduceWithIndex(t, [], (a, p, param) => Belt_Array.concat(a, [{
      TAG: "CoordAndVal",
      _0: [
        param[0],
        param[1]
...
function getBasin(t, param) {
  let helper = (t, param, visited) => {
    let y = param[1];
    let x = param[0];
    let v = Array2D$AdventOfCode.getExn(t, [
      x,
      y
    ]);
    if (v < 0) {
...
function solvePart1(data) {
  ...
  return Belt_Array.reduce(Belt_Array.map(getLowPoints(hmap), param => Utils$AdventOfCode.add(param._1, 1)), 0, Utils$AdventOfCode.add);
}
