...
function solvePart2(data) {
  let xs = parse(data);
  let min = Utils$AdventOfCode.minIntInArray(xs);
  let max = Utils$AdventOfCode.maxIntInArray(xs);
  return Utils$AdventOfCode.minIntInArray(Belt_Array.map(Belt_Array.rangeBy(min, max, 1), __x => costAll(xs, __x)));
}
