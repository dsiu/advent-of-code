...
Jest.describe("2021 Day16", (function () {
        ...
        Jest.describe("Expression", (function () {
                ...
                Jest.testAll("sum", sum_tests, (function (param) {
                ...
                Jest.testAll("product", product_tests, (function (param) {
                        return Jest.Expect.toEqual(Jest.Expect.expect(param[0]), param[1]);
                      }));
                ...
                Jest.testAll("min", min_tests, (function (param) {
                        return Jest.Expect.toEqual(Jest.Expect.expect(param[0]), param[1]);
                      }));
                ...
                Jest.testAll("max", max_tests, (function (param) {
                        return Jest.Expect.toEqual(Jest.Expect.expect(param[0]), param[1]);
                      }));
                ...
                Jest.testAll("greater", greater_tests, (function (param) {
                        return Jest.Expect.toEqual(Jest.Expect.expect(param[0]), param[1]);
                      }));
                ...
                Jest.testAll("less", less_tests, (function (param) {
                        return Jest.Expect.toEqual(Jest.Expect.expect(param[0]), param[1]);
                      }));
                ...
                Jest.describe("Packet with Expression", (function () {
                        ...
                        var expr_tests$1 = Belt_List.map(expr_tests, (function (param) {
                                return [
                        ...
                        Jest.testAll("examples", expr_tests$1, (function (param) {
                                return Jest.Expect.toEqual(Jest.Expect.expect(param[0]), param[1]);
                              }));
                      }));
              }));
