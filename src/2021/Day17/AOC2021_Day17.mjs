...
function toString(r) {
  ...
  if (r.TAG === "Hit") {
    ...
    return "Hit: (" + String(match[0]) + ", " + String(match[1]) + ") | trajectory: [" + (function (__x) {
                return Utils$AdventOfCode.Printable.$$Array.toString(__x, (function (str) {
                              return str;
                            }));
              })(t_str) + "]";
  }
  var t_str$1 = trajectory_str(r._0);
  return "Miss: trajectory: [" + (function (__x) {
              return Utils$AdventOfCode.Printable.$$Array.toString(__x, (function (str) {
                            return str;
                          }));
            })(t_str$1) + "]";
...
function launch(v0, target) {
  var isHit = function (__x) {
    return isTargetHit_(__x, target);
  };
  var isOutOfRange = function (__x) {
    return isOutOfRange_(__x, target);
  };
  var _c = [
    0,
    0
...
function parse(data) {
  ...
  var match$2 = Belt_Array.map(y_str.replace("y=", "").split(".."), (function (y) {
          return Utils$AdventOfCode.intFromStringExn(y);
        }));
  if (match$2.length !== 2) {
    throw {
          RE_EXN_ID: "Match_failure",
