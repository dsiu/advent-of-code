...
function parse(data) {
  return Belt_Array.map(Utils$AdventOfCode.splitNewline(data), line => Belt_Array.map(Utils$AdventOfCode.splitChars(line.trim()), Utils$AdventOfCode.intFromStringExn));
}
