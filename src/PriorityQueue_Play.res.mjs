...
let qInt = PriorityQueue$AdventOfCode.MinPriorityQueue.empty;

let qInt$1 = PriorityQueue$AdventOfCode.MinPriorityQueue.push(PriorityQueue$AdventOfCode.MinPriorityQueue.push(PriorityQueue$AdventOfCode.MinPriorityQueue.push(PriorityQueue$AdventOfCode.MinPriorityQueue.push(PriorityQueue$AdventOfCode.MinPriorityQueue.push(PriorityQueue$AdventOfCode.MinPriorityQueue.push(PriorityQueue$AdventOfCode.MinPriorityQueue.push(PriorityQueue$AdventOfCode.MinPriorityQueue.push(qInt, 10, "e"), 5, "d"), 8, "c"), 3, "b"), 2, "a"), 4, "f"), 6, "g"), 7, "h");
