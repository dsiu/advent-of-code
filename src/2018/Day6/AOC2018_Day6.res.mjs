...
function make$1(xs) {
  ...
  let prim = Utils$AdventOfCode.Printable.MapInt.toString(pinsMap, c => String(c.x) + " " + String(c.y));
  console.log(prim);
  return fill(alloc({
    pins: pinsMap,
    grid: undefined,
...
function solvePart1(data) {
  ...
  console.log(prim);
  let prim$1 = Utils$AdventOfCode.Printable.MapInt.Int.toString(areas, undefined);
  console.log(prim$1);
  let targetPins = getNonInfPin(map);
  let prim$2 = ` ======== target pins (size = ` + String(Belt_MapInt.size(targetPins)) + `)`;
  console.log(prim$2);
  let prim$3 = Utils$AdventOfCode.Printable.MapInt.toString(targetPins, c => String(c.x) + " " + String(c.y));
  console.log(prim$3);
