...
describe("2018 Day3", () => {
  describe("Part1", () => {
    ...
    test(
      "fabric matrix - single value per point +",
      () => {
    ...
    test(
      "fabric matrix - multiple value per point +/*",
      () => {
    ...
    test(
      ...
      () => {
        ...
        let test_fab = allClaims->Belt.Array.reduce(
          test_fab,
          (acc, i) => {
        ...
        let _gp = Fabric.getPoint(test_fab, ...)
