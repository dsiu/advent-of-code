...
function makeClaim(l) {
  let xs = parseLine(l);
  return make(Number.parseInt(Belt_Array.getExn(xs, 1)), Number.parseInt(Belt_Array.getExn(xs, 2)), Number.parseInt(Belt_Array.getExn(xs, 3)), Number.parseInt(Belt_Array.getExn(xs, 4)), Number.parseInt(Belt_Array.getExn(xs, 5)));
}
