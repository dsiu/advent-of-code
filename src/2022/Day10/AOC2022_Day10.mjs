...
var part1 = Utils$AdventOfCode.compose(extractSignals, calculateSixSignals);
...
function isLit(param) {
  ...
  return PervasivesU.abs(param[1] - c | 0) <= 1;
}

function part2(regVals) {
  var pixels = regVals.map(Utils$AdventOfCode.compose(isLit, showPixel));
