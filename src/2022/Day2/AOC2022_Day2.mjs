...
let InvalidShape = /* @__PURE__ */Primitive_exceptions.create("AOC2022_Day2-AdventOfCode.InvalidShape");
...
let InvalidResult = /* @__PURE__ */Primitive_exceptions.create("AOC2022_Day2-AdventOfCode.InvalidResult");
...
function solvePart1(data) {
  let rounds = Belt_Array.map(Utils$AdventOfCode.splitNewline(data), makeRound);
  return Utils$AdventOfCode.sumIntArray(Belt_Array.map(rounds, scoreRound));
}
