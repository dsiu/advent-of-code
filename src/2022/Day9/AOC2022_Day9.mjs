...
let ParseError = /* @__PURE__ */Primitive_exceptions.create("AOC2022_Day9.ParseError");
...
function knotStep(param, kt) {
  let h = param[0];
  let kt$p = touching(kt, h) ? kt : Coord_V2.add(kt, towards(kt, h));
  return [
    kt$p,
    [kt$p].concat(param[1])
  ];
...
function parse(data) {
  return Utils.splitNewline(data).map(x => {
