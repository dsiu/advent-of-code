...
function interestingPosition(n, text) {
  ...
  let packetPos = Stdlib__Array.headUnsafe(Stdlib__Array.dropWhile(candidates, Utils.compose(prim => prim[1], hasSame)));
  return n + packetPos[0] | 0;
}

function solvePart1(data) {
  return interestingPosition(4, Utils.splitChars(data));
}

function solvePart2(data) {
  return interestingPosition(14, Utils.splitChars(data));
}
