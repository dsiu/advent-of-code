...
describe("2022 Day6", (function () {
        test("Part 1 - Sample Data", (function () {
                var result = AOC2022_Day6$AdventOfCode.solvePart1(AOC2022_Day6_Data_Sample$AdventOfCode.data);
        ...
        test("Part 2 - Sample Data", (function () {
                var result = AOC2022_Day6$AdventOfCode.solvePart2(AOC2022_Day6_Data_Sample$AdventOfCode.data);
