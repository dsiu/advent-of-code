...
describe("2022 Day6", () => {
  ...
  testAll("Part 1 - Sample Data", part1SampleData, ((result, expected)) => {
  ...
  testAll("Part 2 - Sample Data", part2SampleData, ((result, expected)) => {
    expect(result)->toEqual(expected)
  })
