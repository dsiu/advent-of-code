...
import * as AOC2023_Day1 from "./AOC2023_Day1.res.mjs";
import * as AOC2023_Day1_Data from "./AOC2023_Day1_Data.res.mjs";
import * as AOC2023_Day1_Data_Sample from "./AOC2023_Day1_Data_Sample.res.mjs";

Jest.describe("2023 Day1", () => {
  Jest.test("Part 1 - Sample Data", () => {
    let result = AOC2023_Day1.solvePart1(AOC2023_Day1_Data_Sample.data);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), 142);
  });
  Jest.test("Part 1 - Solve", () => {
    let result = AOC2023_Day1.solvePart1(AOC2023_Day1_Data.data);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), 54159);
  });
  Jest.test("Part 2 - Sample Data", () => {
    let result = AOC2023_Day1.solvePart2(AOC2023_Day1_Data_Sample.data2);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), 281);
  });
  Jest.test("Part 2 - Solve", () => {
    let result = AOC2023_Day1.solvePart2(AOC2023_Day1_Data.data);
