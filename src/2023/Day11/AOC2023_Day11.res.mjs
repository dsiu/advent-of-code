...
function maxCoord(galaxies) {
  return Stdlib__Array.reduce(Array.from(galaxies._0), [
    0n,
    0n
  ], (param, param$1) => {
...
function expand(galaxies, param, scale) {
  ...
  return {
    TAG: "Galaxies",
    _0: new Set(expandXY(Array.from(galaxies._0)))
  };
}
...
function distances(galaxies) {
  let galaxies$1 = Array.from(galaxies._0);
...
function parse(data) {
  let xy = Utils$AdventOfCode.splitNewline(data).map(r => r.trim().split(""));
  return {
    TAG: "Galaxies",
