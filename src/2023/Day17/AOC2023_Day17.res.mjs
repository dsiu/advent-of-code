...
function cmp(param, param$1) {
  let dir2 = param$1[0];
  let posCmp = Coord_V2$AdventOfCode.compare(param[1], param$1[1]);
  if (posCmp !== 0) {
    return posCmp;
  }
  switch (param[0]) {
...
function toPositions(here, param) {
  ...
  return Stdlib_Array.fromInitializer(param._1 - 1 | 0, i => i + 1 | 0).map(i => Coord_V2$AdventOfCode.add(here, Coord_V2$AdventOfCode.mul(d, i)));
}
