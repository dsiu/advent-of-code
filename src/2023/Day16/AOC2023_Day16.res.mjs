...
import * as Coord_V2$AdventOfCode from "../../Coord_V2.res.mjs";
...
function cmp$1(param, param$1) {
  ...
  let posEq = Coord_V2$AdventOfCode.compare(match$1[0], match[0]);
...
function bounds(grid) {
  ...
  return [
    Stdlib__Array.reduce(rows, Stdlib_Int.Constants.minValue, (prim0, prim1) => Math.max(prim0, prim1)),
    Stdlib__Array.reduce(cols, Stdlib_Int.Constants.minValue, (prim0, prim1) => Math.max(prim0, prim1))
  ];
}
      ...
      switch (match$2[1]) {
        case "U" :
          return [{
              TAG: "BeamHead",
              _0: [
                Coord_V2$AdventOfCode.add(pos$1, [
                  0,
                  -1
                ]),
                "L"
      ...
      switch (match$3[1]) {
        ...
        case "L" :
          return [{
              TAG: "BeamHead",
              _0: [
                Coord_V2$AdventOfCode.add(pos$2, [
                  0,
                  -1
                ]),
                "L"
      ...
      switch (match$4[1]) {
        case "U" :
          return [{
              TAG: "BeamHead",
              _0: [
                Coord_V2$AdventOfCode.add(pos$3, [
                  -1,
                  0
                ]),
                "U"
...
function parse(data) {
  return Utils$AdventOfCode.splitNewline(data).map(l => l.trim().split(""));
}
