...
function bounds(grid) {
  ...
  return [
    Stdlib__Array.reduce(rows, Core__Int.Constants.minValue, (prim0, prim1) => Math.max(prim0, prim1)),
    Stdlib__Array.reduce(cols, Core__Int.Constants.minValue, (prim0, prim1) => Math.max(prim0, prim1))
  ];
}
