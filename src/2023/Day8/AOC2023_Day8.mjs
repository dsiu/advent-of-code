...
function compare(param, param$1) {
  ...
  if (Stdlib__Ordering.isEqual(h)) {
    return Caml.int_compare(param.steps, param$1.steps);
  } else {
    return h;
  }
}
...
function part2(param) {
  ...
  return Stdlib__Array.foldl1(Array.from(desert.keys()).filter(function (extra) {
                      return Stdlib__Function.compose3(Stdlib__String.last, (function (extra) {
                                    return Stdlib__String.compare("A", extra);
                                  }), Stdlib__Ordering.isEqual, extra);
                    }).map(function (s) {
...
var nameP = ReludeParse_Parser.$less$$$great(ReludeParse_Parser.many(ReludeParse_Parser.anyAlphaOrDigit), (function (l) {
        return Stdlib__List.toArray(l).join("");
      }));

var nodeP = ReludeParse_Parser.Infix.$less$star$great(ReludeParse_Parser.Infix.$less$$great(mkNode, ReludeParse_Parser.Infix.$less$star(ReludeParse_Parser.Infix.$star$great(ReludeParse_Parser.str("("), nameP), ReludeParse_Parser.str(", "))), ReludeParse_Parser.Infix.$less$star(nameP, ReludeParse_Parser.str(")")));

var desertLineP = ReludeParse_Parser.Infix.$less$star$great(ReludeParse_Parser.Infix.$less$$great(mkDesertLine, ReludeParse_Parser.Infix.$less$star(ReludeParse_Parser.Infix.$star$great(justSpace, nameP), ReludeParse_Parser.str(" = "))), nodeP);

function mkDesert(a) {
  return new Map(Stdlib__List.toArray(a));
}

var desertP = ReludeParse_Parser.Infix.$less$$great(mkDesert, ReludeParse_Parser.sepBy(ReludeParse_Parser.eol, desertLineP));

var directionP = ReludeParse_Parser.Infix.$less$pipe$great(ReludeParse_Parser.Infix.$less$("L", ReludeParse_Parser.str("L")), ReludeParse_Parser.Infix.$less$("R", ReludeParse_Parser.str("R")));
...
var problemP = ReludeParse_Parser.Infix.$less$star$great(ReludeParse_Parser.Infix.$less$$great(mkProblem, ReludeParse_Parser.Infix.$less$star(ReludeParse_Parser.many(directionP), ReludeParse_Parser.many1(ReludeParse_Parser.eol))), desertP);
