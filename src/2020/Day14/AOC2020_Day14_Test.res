...
describe("2020 Day14", () => {
  test("Part 1 - Sample Data", () => {
    ...
    let expected = BigInt.fromStringOrThrow("165")
  ...
  test("Part 1 - Solve", () => {
    ...
    let expected = BigInt.fromStringOrThrow("17765746710228")
  ...
  test("Part 2 - Mem Address Decoder 1 ", () => {
    ...
    let address = BigInt.fromStringOrThrow("42")
  ...
  test("Part 2 - Mem Address Decoder 2 ", () => {
    ...
    let address = BigInt.fromStringOrThrow("26")
  ...
  test("Part 2 - Solve", () => {
    ...
    let expected = BigInt.fromStringOrThrow("4401465949086")
