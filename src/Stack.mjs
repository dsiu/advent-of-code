...
function MakeStack(Item) {
  ...
  var square = function (extra) {
    return Stdlib__Function.compose(dup, mul, extra);
  };
  var cube = function (extra) {
    return Stdlib__Function.compose4(dup, dup, mul, mul, extra);
  };
  var sum_numbers_upto = function (extra) {
...
function sum_numbers_upto(extra) {
  return Stdlib__Function.compose((function (extra) {
                return Stdlib__Function.compose4(dup, one, add$1, mul$1, extra);
              }), (function (extra) {
                return Stdlib__Function.compose(two, div$1, extra);
              }), extra);
}
...
function sum_numbers_upto$1(extra) {
  return Stdlib__Function.compose((function (extra) {
                return Stdlib__Function.compose4(dup$1, one$1, add$3, mul$3, extra);
              }), (function (extra) {
                return Stdlib__Function.compose(two$1, div$3, extra);
              }), extra);
}
