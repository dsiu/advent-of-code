...
let InvalidDirection = /* @__PURE__ */Primitive_exceptions.create("AOC2019_Day3-AdventOfCode.InvalidDirection");
...
function travelSegment(path, segment) {
  ...
  let tip$p = Coord_V2$AdventOfCode.add(start, Coord_V2$AdventOfCode.mul(delta, distance));
  return {
    visited: visited$p,
    tip: tip$p,
    currentLength: len$p
