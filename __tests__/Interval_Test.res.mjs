...
import * as Interval$AdventOfCode from "../src/Interval.res.mjs";
...
Jest.describe("Interval", () => {
  ...
  Jest.describe("isOverlap", () => {
    Jest.test("isOverlap - returns true when intervals overlap", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(5), BigInt(10));
      let interval2 = Interval$AdventOfCode.make(BigInt(7), BigInt(12));
    ...
    Jest.test("isOverlap - returns false when intervals do not overlap", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(5), BigInt(10));
      let interval2 = Interval$AdventOfCode.make(BigInt(11), BigInt(15));
    ...
    Jest.test("isOverlap - returns true when intervals touch at one point on right", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(5), BigInt(10));
      let interval2 = Interval$AdventOfCode.make(BigInt(10), BigInt(15));
      return Jest.Expect.toBe(Jest.Expect.expect(Interval$AdventOfCode.isOverlap(interval1, interval2)), true);
    });
    Jest.test("isOverlap - returns true when intervals touch at one point on left", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(6), BigInt(11));
      let interval2 = Interval$AdventOfCode.make(BigInt(3), BigInt(6));
      return Jest.Expect.toBe(Jest.Expect.expect(Interval$AdventOfCode.isOverlap(interval1, interval2)), true);
    });
    Jest.test("isOverlap - returns true when a contains b", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(1), BigInt(10));
      let interval2 = Interval$AdventOfCode.make(BigInt(3), BigInt(6));
      return Jest.Expect.toBe(Jest.Expect.expect(Interval$AdventOfCode.isOverlap(interval1, interval2)), true);
    });
    Jest.test("isOverlap - returns true when b contains a", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(5), BigInt(9));
      let interval2 = Interval$AdventOfCode.make(BigInt(1), BigInt(12));
      return Jest.Expect.toBe(Jest.Expect.expect(Interval$AdventOfCode.isOverlap(interval1, interval2)), true);
    });
    Jest.test("isOverlap - returns true when both a and b are some", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(13), BigInt(13));
      let interval2 = Interval$AdventOfCode.make(BigInt(13), BigInt(13));
      return Jest.Expect.toBe(Jest.Expect.expect(Interval$AdventOfCode.isOverlap(interval1, interval2)), true);
    });
  });
  Jest.describe("intersect", () => {
    ...
    Jest.test("intersect - returns intersection both intervals are length 1", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(5), BigInt(5));
      let interval2 = Interval$AdventOfCode.make(BigInt(5), BigInt(5));
    ...
    Jest.test("intersect - returns intersection a interval is length 1 and the other is inside", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(7), BigInt(7));
      let interval2 = Interval$AdventOfCode.make(BigInt(1), BigInt(10));
  ...
  Jest.describe("below", () => {
    Jest.test("below - returns true when first interval is below the second", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(5), BigInt(10));
      let interval2 = Interval$AdventOfCode.make(BigInt(12), BigInt(15));
    ...
    Jest.test("below - returns false when first interval is above the second", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(12), BigInt(15));
      let interval2 = Interval$AdventOfCode.make(BigInt(5), BigInt(10));
  ...
  Jest.describe("adjacent", () => {
    ...
    Jest.test("adjacent - returns false when intervals are not adjacent and not overlapping", () => {
      let interval1 = Interval$AdventOfCode.make(BigInt(5), BigInt(10));
      let interval2 = Interval$AdventOfCode.make(BigInt(15), BigInt(20));
      return Jest.Expect.toBe(Jest.Expect.expect(Interval$AdventOfCode.adjacent(interval1, interval2)), false);
    });
  });
  Jest.describe("remove", () => {
    Jest.test("remove - returns a when intervals do not overlap", () => {
      let a = Interval$AdventOfCode.make(BigInt(1), BigInt(5));
      let b = Interval$AdventOfCode.make(BigInt(6), BigInt(10));
      let result = Interval$AdventOfCode.remove(a, b);
      let expected = [
        BigInt(1),
        BigInt(5)
      ];
    ...
    Jest.test("remove - returns None when b is all contained within a", () => {
      let a = Interval$AdventOfCode.make(BigInt(1), BigInt(10));
      let b = Interval$AdventOfCode.make(BigInt(3), BigInt(7));
      let result = Interval$AdventOfCode.remove(a, b);
      return Jest.Expect.toEqual(Jest.Expect.expect(result), undefined);
    });
    Jest.test("remove - returns None when a is contained within b", () => {
      let a = Interval$AdventOfCode.make(BigInt(3), BigInt(7));
      let b = Interval$AdventOfCode.make(BigInt(1), BigInt(10));
      let result = Interval$AdventOfCode.remove(a, b);
      return Jest.Expect.toEqual(Jest.Expect.expect(result), undefined);
    });
    ...
    Jest.test("remove - returns None when a and b are single point intervals and are the same", () => {
      let a = Interval$AdventOfCode.make(BigInt(3), BigInt(3));
      let b = Interval$AdventOfCode.make(BigInt(3), BigInt(3));
      let result = Interval$AdventOfCode.remove(a, b);
      return Jest.Expect.toEqual(Jest.Expect.expect(result), undefined);
    });
    Jest.test("remove - returns Some(a) when a and b are single point intervals and are different", () => {
      let a = Interval$AdventOfCode.make(BigInt(3), BigInt(3));
      let b = Interval$AdventOfCode.make(BigInt(4), BigInt(4));
      let result = Interval$AdventOfCode.remove(a, b);
      let expected = [
        BigInt(3),
        BigInt(3)
  ...
  Jest.describe("merge", () => {
    ...
    Jest.test("merge - throws error when intervals are not connected or overlapping", () => {
      ...
      let mergeFunction = () => Interval$AdventOfCode.merge(interval1, interval2);
  ...
  Jest.describe("sortAndMergeOverlaps", () => {
    Jest.test("sortAndMergeOverlaps - overlapping intervals", () => {
      ...
      let result = Interval$AdventOfCode.sortAndMergeOverlaps(intervals);
      let expected = [[
          BigInt(1),
          BigInt(8)
        ]];
