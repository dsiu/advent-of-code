...
import * as Array2D$AdventOfCode from "../src/Array2D.res.mjs";

Jest.describe("make", () => {
  Jest.test("make - int", () => {
    let a = Array2D$AdventOfCode.make([
      3,
      2
    ], -1);
    [
...
Jest.describe("Array2D.make", () => {
  Jest.test("should create a 2D array with given dimensions and initial value", () => {
    let result = Array2D$AdventOfCode.make([
      3,
      2
    ], 0);
...
Jest.describe("copy", () => {
  Jest.test("should create a copy of a 2D array", () => {
    let original = Array2D$AdventOfCode.make([
      3,
      2
    ], 0);
    let copy = Array2D$AdventOfCode.copy(original);
  ...
  Jest.test("should not affect the original array when modifying the copy", () => {
    ...
    let copy = Array2D$AdventOfCode.copy(original);
    Array2D$AdventOfCode.set(copy, [
      1,
      1
    ], 1);
    return Jest.Expect.toEqual(Jest.Expect.expect(original), Array2D$AdventOfCode.make([
      3,
      2
    ], 0));
  });
...
Jest.describe("lengthY", () => {
  Jest.test("should return the number of rows in the 2D array", () => {
    let array2D = Array2D$AdventOfCode.make([
      3,
      2
    ], 0);
  ...
  Jest.test("should return 0 for an empty 2D array", () => {
    ...
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.lengthY(array2D)), 0);
  });
});
...
Jest.describe("lengthX", () => {
  ...
  Jest.test("should return 0 for an empty 2D array", () => {
    ...
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.lengthX(array2D)), 0);
  });
});
...
Jest.describe("isValidXY", () => {
  Jest.test("should return true for valid coordinates", () => {
    ...
    return Jest.Expect.toBe(Jest.Expect.expect(Array2D$AdventOfCode.isValidXY(array2D, [
      1,
      1
    ])), true);
  });
...
Jest.describe("set", () => {
  Jest.test("should set the value at the given coordinates", () => {
    ...
    Array2D$AdventOfCode.set(array2D, [
      1,
      1
    ], 1);
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.get(array2D, [
      1,
      1
    ])), 1);
  });
...
Jest.describe("setYEquals", () => {
  Jest.test("should set the entire row to the given array", () => {
    ...
    Array2D$AdventOfCode.setYEquals(array2D, 1, [
      1,
      1,
      1
    ]);
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.getYEquals(array2D, 1)), [
      1,
      1,
      1
    ]);
  ...
  Jest.test("should not change other rows", () => {
    ...
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.getYEquals(array2D, 0)), [
      0,
      0,
      0
    ]);
...
Jest.describe("getExn", () => {
  Jest.test("should return the value at the given coordinates", () => {
    ...
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.getExn(array2D, [
      1,
      1
    ])), 0);
  });
  Jest.test("should throw an exception for invalid coordinates", () => {
    ...
    let fn = () => Array2D$AdventOfCode.getExn(array2D, [
      3,
      2
    ]);
...
Jest.describe("getYEquals", () => {
  ...
  Jest.test("should return None for invalid index", () => {
    ...
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.getYEquals(array2D, 2)), undefined);
  });
});
...
Jest.describe("getXEquals", () => {
  Jest.test("should return the column at the given index", () => {
    ...
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.getXEquals(array2D, 1)), [
      0,
      0
    ]);
  });
  Jest.test("should return None for invalid index", () => {
    ...
    return Jest.Expect.toEqual(Jest.Expect.expect(Array2D$AdventOfCode.getXEquals(array2D, 3)), undefined);
  });
});
...
Jest.describe("map", () => {
  Jest.test("should apply the function to each element in the 2D array", () => {
    ...
    let result = Array2D$AdventOfCode.map(array2D, x => (x << 1));
    return Jest.Expect.toEqual(Jest.Expect.expect(result), [
      [
        2,
        2,
  ...
  Jest.test("should not modify the original 2D array", () => {
    ...
    Array2D$AdventOfCode.map(array2D, x => (x << 1));
...
Jest.describe("mapWithIndex", () => {
  Jest.test("should apply the function to each element with its coordinates", () => {
    ...
    let result = Array2D$AdventOfCode.mapWithIndex(array2D, (coords, param) => coords);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), [
      [
        [
          0,
  ...
  Jest.test("should not modify the original 2D array", () => {
    ...
    Array2D$AdventOfCode.mapWithIndex(array2D, (coords, param) => coords);
    return Jest.Expect.toEqual(Jest.Expect.expect(array2D), [
      [
        0,
        0,
...
Jest.describe("reduce", () => {
  Jest.test("should correctly reduce a 2D array to a single value", () => {
    ...
    let result = Array2D$AdventOfCode.reduce(array2D, 0, (acc, x) => acc + x | 0);
  ...
  Jest.test("should return the initial value for an empty 2D array", () => {
    ...
    let result = Array2D$AdventOfCode.reduce(array2D, 10, (acc, x) => acc + x | 0);
...
Jest.describe("reduceWithIndex", () => {
  Jest.test("should correctly reduce a 2D array to a single value with index", () => {
    ...
    let result = Array2D$AdventOfCode.reduceWithIndex(array2D, 0, (acc, x, param) => acc + x | 0);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), 6);
  });
  Jest.test("should return the initial value for an empty 2D array", () => {
    let array2D = Array2D$AdventOfCode.make([
    ...
    let result = Array2D$AdventOfCode.reduceWithIndex(array2D, 10, (acc, x, param) => acc + x | 0);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), 10);
  });
...
Jest.describe("flatten", () => {
  Jest.test("should flatten a 2D array into a 1D array", () => {
    ...
    let result = Array2D$AdventOfCode.flatten(array2D);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), [
      1,
      1,
      1,
...
Jest.describe("crop", () => {
  ...
  Jest.test("should correctly crop a 2D array (1)", () => {
    let result = Array2D$AdventOfCode.crop(array2D, [
      1,
      1
    ], 2, 2);
    return Jest.Expect.toEqual(Jest.Expect.expect(result), [
...
Jest.describe("eq", () => {
  Jest.test("should return true for identical 2D arrays", () => {
    let array2D1 = Array2D$AdventOfCode.make([
      3,
      2
    ], 1);
    let array2D2 = Array2D$AdventOfCode.make([
      3,
      2
    ], 1);
...
Jest.describe("get / set", () => {
  let s = Array2D$AdventOfCode.make([
    2,
    2
  ], "");
  [
  ...
  let b = Array2D$AdventOfCode.copy(a);
  let get_tests_0 = [
...
Jest.describe("keep / map / getXYEquals / crop", () => {
  ...
  Jest.test("map - int", () => {
    let result = Array2D$AdventOfCode.map(a, x => (x << 1));
    let expected = [
      [
        710,
        1814,
