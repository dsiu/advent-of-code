...
import * as Powerset from "../src/Powerset.res.mjs";
...
Jest.describe("Powerset", () => {
  ...
  Jest.describe("powerset_array_with_list()", () => {
    let int_tests_0 = [
      Powerset.powersetArrayWithList_(int_array_1),
      int_array_1_result
    ];
    let int_tests = {
      hd: int_tests_0,
    ...
    let string_tests_0 = [
      Powerset.powersetArrayWithList_(string_array_1),
  ...
  Jest.describe("powerset_array()", () => {
    let int_tests_0 = [
      Powerset.powersetArray(int_array_1),
      int_array_1_result
    ];
    let int_tests = {
      hd: int_tests_0,
    ...
    let string_tests_0 = [
      Powerset.powersetArray(string_array_1),
      string_array_1_result
    ];
    let string_tests = {
      hd: string_tests_0,
