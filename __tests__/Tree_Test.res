...
describe("Tree", () => {
  ...
  let toString = List.map(_, ((t, r)) => (t->locToString, r->locToString))
  let left_tests =
    list{
  ...
  testAll("left", left_tests, ((result, expected)) => {
  ...
  testAll("right", right_tests, ((result, expected)) => {
    expect(result)->toEqual(expected)
  })
  ...
  testAll("left right", left_right_tests, ((result, expected)) => {
    expect(result)->toEqual(expected)
  })
  ...
  testAll("upmost", upmost_tests, ((result, expected)) => {
    expect(result)->toEqual(expected)
  })
  ...
  testAll("up", up_tests, ((result, expected)) => {
    expect(result)->toEqual(expected)
  })
  ...
  testAll("modify", modify_tests, ((result, expected)) => {
    expect(result)->toEqual(expected)
  })
})
